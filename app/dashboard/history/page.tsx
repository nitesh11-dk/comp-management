...
export default function SupervisorHistoryPage() {
    ...
    if (loading)
        return <div className="text-center py-10 text-gray-500">Loading scan history...</div>;
    ...
    return (
        <div className="space-y-4 px-2 sm:px-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-center sm:text-left">
                Supervisor Scan History — Department: {logs[0]?.departmentName || "N/A"}
            </h2>
            ...
            <Card className="overflow-x-auto">
                <table className="min-w-full border border-gray-200 text-sm sm:text-base">
                    ...
                    <tbody>
                        {logs.length === 0 ? (
                            <tr>
                                <td colSpan={4} className="text-center px-2 sm:px-4 py-2">
