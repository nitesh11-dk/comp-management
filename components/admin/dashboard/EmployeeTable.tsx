                        ...
                        <thead className="sticky top-0 z-20">
                            <tr className="bg-slate-50 border-b border-slate-200">
                                {columnVisibility.name && (
                                    <th className="sticky left-0 z-30 bg-slate-50 w-[150px] md:w-[180px] px-3 md:px-4 py-3 text-left text-xs font-semibold text-slate-900 uppercase whitespace-nowrap border-r border-slate-200 shadow-[2px_0_4px_-1px_rgba(0,0,0,0.08)]">
                                        Name
                                    </th>
                                )}
                        ...
                        <tbody className="bg-white divide-y divide-gray-100">
                            {loading && (
                                <tr>
                                    <td
                                        ...
                                        className="px-4 py-12 text-center text-slate-500 bg-slate-50/30"
                                    >
                                        <div className="flex flex-col items-center justify-center gap-2">
                                            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
                                            <span className="text-sm font-medium">Refreshing employee data...</span>
                                        </div>
                                    </td>
                                </tr>
                            )}
                            ...
                            {!loading && rows.length === 0 && (
                                <tr>
                                    <td
                                        colSpan={Object.values(columnVisibility).filter(Boolean).length}
                                        className="px-4 py-12 text-center text-slate-400 italic bg-slate-50/10"
                                    >
                                ...
                                rows.map(({ employee, summary }) => {
                                    ...
                                    return (
                                        <EmployeeRow
                                            ...
                                            barcodeRef={(el) => { barcodeRefs.current[employee.id] = el; }}
